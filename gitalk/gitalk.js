...
var GitalkComponent = function (_Component) {
  ...
  function GitalkComponent(props) {
    ...
    if (query.code) {
      var code = query.code;
      delete query.code;
      var replacedUrl = '' + window.location.origin + window.location.pathname + (0, _util.queryStringify)(query);
  ...
  (0, _createClass3.default)(GitalkComponent, [{
    ...
    key: 'accessToken',
    get: function get() {
      return this._accessToken || window.localStorage.getItem(_const.GT_ACCESS_TOKEN);
    },
